...
public class DoWhileStatementWithoutCond extends Matched {
    ...
    public DoWhileStatementWithoutCond (DoWhileStart DoWhileStart, Statement Statement, WhileStart WhileStart, DoWhileEnd DoWhileEnd) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DoWhileStatementWithoutCond(\n");
