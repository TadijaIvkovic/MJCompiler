...
public class VarDeclarationListDerived1 extends VarDeclarationList {

    private VarDeclarationList VarDeclarationList;
    private VarDeclaration VarDeclaration;

    public VarDeclarationListDerived1 (VarDeclarationList VarDeclarationList, VarDeclaration VarDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclarationListDerived1(\n");
