...
public class ActParamListDerived1 extends ActParamList {

    private ActParamList ActParamList;
    private Expr Expr;

    public ActParamListDerived1 (ActParamList ActParamList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParamListDerived1(\n");
